    ...
    <>
      ...
      <aside className="main-sidebar sidebar-light-primary elevation-4">
        <a href="i" className="brand-link">
          <img
            src="logo/logoethosWord.png"
            alt="Ethos world Logo"
            className="brand-image brand-text font-weight-light"
          />
          <br />
            ...
            >
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <p className="nav-pills">Logout</p>
                </Link>
              </li>
            </ul>
          </nav>
